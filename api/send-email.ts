    ...
    const htmlBody = `
      <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #e5e7eb; border-radius: 16px; background-color: #fafafa; color: #1f2937;">
        ...
        <div style="text-align: center; border-bottom: 2px solid #D71920; padding-bottom: 20px; margin-bottom: 25px;">
          <h2 style="color: #D71920; margin: 0; font-size: 24px; text-transform: uppercase; letter-spacing: -0.5px;">hoangyenbds.vn</h2>
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #374151;">
          Chào chị <strong>Hoàng Yến</strong>, một khách hàng vừa thực hiện tính toán dòng tiền và gửi thông tin đăng ký tư vấn trực tiếp từ website <strong>hoangyenbds.vn</strong>.
        </p>
        ...
        <div style="font-size: 11px; color: #9ca3af; text-align: center; margin-top: 30px; border-top: 1px solid #e5e7eb; padding-top: 15px;">
          <p style="margin: 0 0 5px 0;">Hệ thống gửi thư tự động tích hợp từ hoangyenbds.vn</p>
          <p style="margin: 0;">© ${new Date().getFullYear()} Hoàng Yến BĐS – All Rights Reserved.</p>
        </div>
      </div>
    `;

    await transporter.sendMail({
      from: `"CRM hoangyenbds.vn" <${smtpUser}>`,
      to: receiverEmail,
