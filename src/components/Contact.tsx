...
import { Phone, MessageCircle, Facebook, Link2 } from 'lucide-react';
...
export default function Contact() {
  const contactButtons = [
    ...
    },
    {
      ...
      description: 'Nhận bảng tính file gốc dòng tiền chi tiết',
    ...
    },
    {
      ...
      description: 'Xem hoạt động & kết nối trực tiếp',
      label: 'Hoàng Yến BĐS',
    ...
    <section className="relative w-full py-8 px-4">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <h2 className="text-2xl font-sans font-black text-white tracking-tight uppercase">
          Kết nối trực tiếp với Hoàng Yến
        </h2>
