...
export default function Projects() {
  ...
  const handleSendLead = (e: FormEvent) => {
    ...
    if (!leadName.trim() || !leadPhone.trim()) {
      setFormError('Vui lòng điền đủ Tên và Số điện thoại.');
      return;
    }
    
    // Build direct prefilled Zalo text message
    const message = `Xin chào Hoàng Yến! Tôi là ${leadName} (${leadPhone}). Tôi đang tìm hiểu dự án ${selectedProject?.name}. Hãy gửi cho tôi thông tin bảng hàng tư vấn và chiết khấu mới nhất nhé!`;
            ...
            >
              ...
              <div className="text-center mb-5 mt-1">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Hoàng Yến sẽ gửi trực tiếp bảng hàng, danh sách chuyển nhượng nội bộ qua Zalo.
                </p>
              </div>
              ...
              <form onSubmit={handleSendLead} className="space-y-4">
                ...
                <div className="text-[11px] text-gray-400 leading-relaxed bg-white/5 p-3 rounded-xl border border-white/5">
                  🛡️ <strong className="text-white">Cam kết từ Hoàng Yến:</strong> Bảo mật tuyệt đối thông tin, không làm phiền, chỉ cung cấp thông tin trung thực, phân tích kỹ tối ưu nhất cho nhu cầu của anh/chị.
                </div>
