      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col">
          <span className="text-white font-display font-black tracking-tight text-sm uppercase">
            hoangyen<span className="text-brand-red">bds</span>.vn
          </span>
          <span className="text-[9px] text-gray-400 font-mono tracking-widest uppercase font-semibold">Hoàng Yến</span>
        </div>
      </div>
