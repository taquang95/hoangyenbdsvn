    ...
    <section className="relative w-full py-8 px-4">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <h2 className="text-2xl font-sans font-black text-white tracking-tight uppercase">
          Vì sao nên làm việc với Hoàng Yến?
        </h2>
      ...
      <div className="mt-8 p-4 bg-gradient-to-tr from-brand-red/10 to-transparent border border-brand-red/15 rounded-2xl text-center">
        <p className="text-xs text-gray-300 font-sans leading-relaxed">
          🤝 <strong className="text-white">Đặt uy tín lên hàng đầu:</strong> Hoàng Yến luôn tư vấn dựa trên sự thật, minh bạch về giá cả, phân tích khách quan tất cả ưu nhược điểm dự án. Giao dịch luôn đính kèm sự an tâm tuyệt đối.
        </p>
      </div>
    </section>
  );
